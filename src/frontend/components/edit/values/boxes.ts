...
export const trackerEdits = [
    ...
    {
        name: "edit.sub_indexes",
        input: "checkbox",
        id: "tracker.childProgress",
        value: false,
    },
    {
        name: "edit.one_letter",
        input: "checkbox",
        id: "tracker.oneLetter",
        value: false,
    },
]
            ...
            lines: [
                {
                    ...
                    input: "number",
                    value: 1.1,
                    values: { max: 10, step: 0.1, decimals: 1, inputMultiplier: 10 },
                    extension: "em",
                },
                {
                    name: "line_spacing",
                    id: "specialStyle.lineGap",
                    input: "number",
                    value: 0,
                    values: { max: 500 },
                },
                ...
                },
                {
                    ...
                    id: "specialStyle.opacity",
                    input: "number",
                    value: 1,
                    values: { step: 0.1, decimals: 1, max: 1, inputMultiplier: 10 },
                },
            ],
            outline: [
                {
                    ...
                    values: {
                        options: [
                            ...
                            { id: "decimal", name: "$:list.decimal:$" },
                            {
                                ...
                                name: "$:list.decimal-leading-zero:$",
                            },
                            // alpha
        ...
        edit: {
            default: [
                { id: "src", input: "media" },
                {
                    ...
                    input: "dropdown",
                    value: "contain",
                    values: { options: mediaFitOptions },
                },
                { name: "actions.mute", id: "muted", input: "checkbox", value: false },
                {
                    name: "media.flip_horizontally",
                    id: "flipped",
                    input: "checkbox",
                    value: false,
                },
                {
                    name: "media.flip_vertically",
                    id: "flippedY",
                    input: "checkbox",
                    value: false,
                },
            ...
            filters: [
                ...
                },
                {
                    ...
                    input: "number",
                    value: 0,
                    values: { max: 1, step: 0.1, decimals: 1, inputMultiplier: 10 },
                },
                {
                    name: "filter.blur",
                    id: "filter",
    ...
    events: {
        ...
        edit: {
            default: [
                ...
                {
                    name: "start_days_from_today",
                    id: "events.startDaysFromToday",
                    disabled: "events.enableStartDate",
                    input: "number",
                    value: 0,
                    values: { max: 10000 },
                },
                {
                    name: "just_one_day",
                    id: "events.justOneDay",
                    input: "checkbox",
                    value: false,
                },
                {
                    name: "enable_start_date",
                    id: "events.enableStartDate",
                    input: "checkbox",
                    value: false,
                },
                {
                    name: "calendar.from_date",
                    id: "events.startDate",
                    hidden: true,
                    input: "date",
                },
                {
                    name: "calendar.from_time",
                    id: "events.startTime",
                    hidden: true,
                    input: "time",
                },
    ...
    mirror: {
        ...
        edit: {
            ...
            default: [
                ...
                {
                    name: "use_slide_index",
                    id: "mirror.useSlideIndex",
                    input: "checkbox",
                    value: true,
                },
                {
                    name: "slide_index",
                    disabled: "mirror.useSlideIndex",
                    id: "mirror.index",
                    input: "number",
                    value: 0,
                },
    ...
    captions: {
        ...
        edit: {
            default: [
                ...
                // label?
                {
                    name: "captions.powered_by",
                    values: { subtext: "CAPTION.Ninja" },
                    input: "tip",
                },
            ],
