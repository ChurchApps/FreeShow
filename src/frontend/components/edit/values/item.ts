...
export const itemEdits: { [key: string]: EditInput[] } = {
    ...
    transform: [
        ...
        },
        {
            ...
            input: "number",
            value: 1,
            values: { min: -1, max: 1, step: 0.1, decimals: 1, inputMultiplier: 10 },
        },
        {
            name: "tilt",
            id: "transform",
    ...
    style: [
        ...
        },
        {
            ...
            input: "number",
            value: 0,
            values: { step: 10, max: 500, inputMultiplier: 0.1 },
            extension: "px",
        },
    ],
    border: [
