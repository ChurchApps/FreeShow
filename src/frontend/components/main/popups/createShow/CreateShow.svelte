...
{#if selectedOption === "text"}
    ...
    {#if showMore}
        <List top={5}>
            ...
            <MaterialToggleSwitch label="create_show.songselect_mode" title="create_show.songselect_mode_tip" checked={$special.songselectMode === true} defaultValue={false} on:change={(e) => special.set({ ...$special, songselectMode: e.detail })} />
