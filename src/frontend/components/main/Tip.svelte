...
<div class="tip {type}" style="{style}margin-top: {top}px;margin-bottom: {bottom}px;">
    <Icon id={type} size={1.2} gradient gradientColor={type === "warning" ? "#FFA500" : type === "info" ? "#00BFFF" : null} />
