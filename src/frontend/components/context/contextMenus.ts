...
export const contextMenuLayouts: { [key: string]: string[] } = {
    ...
    // OUTPUTS
    output_preview: ["edit", "SEPARATOR", "toggle_output"],
    ...
    category_shows_button: ["rename", "changeIcon", "delete", "SEPARATOR", "category_action", "use_as_archive"],
    ...
    camera_card: ["edit", "SEPARATOR", "recording"],
    // actions
