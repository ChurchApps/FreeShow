...
export const contextMenuItems: { [key: string]: ContextMenuItem } = {
    ...
    mark_played: { label: "actions.mark_played", icon: "circle_outline", iconColor: "var(--text)" },
...
export const contextMenuLayouts: { [key: string]: string[] } = {
    ...
    project_media: ["play", "play_no_audio", "play_no_filters", "SEPARATOR", "mark_played", "SEPARATOR", "remove"],
    project_audio: ["mark_played", "SEPARATOR", "remove"],
    ...
    project_show: ["mark_played", "SEPARATOR", "remove", "SEPARATOR", "private", "SEPARATOR", "rename"],
    pco_item: ["unlink_pco"],
    project_section: ["recolor", "SEPARATOR", "remove"],
    project_overlay: ["remove"],
    project_pdf: ["mark_played", "SEPARATOR", "remove"],
    project_ppt: ["mark_played", "SEPARATOR", "remove"],
