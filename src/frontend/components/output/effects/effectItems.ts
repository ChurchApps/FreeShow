export const effectItems = {
    stars: { default: { count: 1000, size: 1, speed: 2 } },
    galaxy: { default: { count: 2000, size: 1.5, swirlStrength: 0.5, rotationSpeed: 10, armCount: 5 } },
    ...
    city: { default: { count: 40, height: 200, width: 40, color: "#222", windowColor: "#ffff99", night: true, flickerSpeed: 1 } },
    fireworks: { default: { speed: 0.5, count: 50, size: 1.5 } },

    rays: { default: { speed: 1, color_1: "#000", color_2: "#FFF", numRays: 8 } },
