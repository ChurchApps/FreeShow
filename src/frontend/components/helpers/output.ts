...
import { getMetadataSlideIndices } from "../../utils/metadataSlideIndex"
...
export function getMetadata(show: Show | undefined, currentStyle: Styles, outSlide: OutSlide | null, _updater = get(templates)) {
    ...
    const { firstActiveSlideIndex, lastActiveSlideIndex } = getMetadataSlideIndices(ref, metadataValues.firstOffset, metadataValues.lastOffset)
