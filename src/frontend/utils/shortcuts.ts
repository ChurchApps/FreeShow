...
export function keydown(e: KeyboardEvent) {
    ...
    if (e.ctrlKey || e.metaKey) {
        ...
        const exeption = ["e", "i", "n", "o", "s", "a", "z", "Z", "y", "x", "B"]
