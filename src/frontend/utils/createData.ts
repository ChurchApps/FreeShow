...
export function setExampleOverlays() {
    overlays.update((a) => {
        ...
        a.clock = {
            ...
            color: "dodgerblue",
            category: "visuals",
            items: [{ style: "top:70px;left:1450px;height:150px;width:470px;font-family:monospace", type: "clock", clock: { type: "digital", dateFormat: "none", showTime: true, seconds: false } }],
        }
        a.name = {
