...
function getDefaultEffects() {
    ...
    a.gradient_deep = {
        ...
        style: "",
        background: "#000000",
        items: [{ type: "mesh_gradient", duration: 24, speed: 1, motion: 0.07, grain: 0, colors: ["#120912", "#110715", "#120a13", "#130915", "#0e060f", "#130a15", "#0b0213", "#0e080a", "#09000f", "#0a040a", "#130917", "#09000a", "#191114", "#0f0020", "#221e21", "#0e001a", "#171118", "#170f1f", "#170d24", "#191f14", "#11001e", "#11140f", "#31253f", "#403542", "#17111c", "#87689f", "#000000", "#a291b9", "#31202d", "#49455b", "#664f80", "#aa9db2", "#00001a", "#7a6981", "#ceb7e9", "#000000"] }] as any[]
    }
    ...
    a.gradient_ember = {
        ...
        style: "",
        background: "#000000",
        items: [{ type: "mesh_gradient", duration: 24, speed: 1, motion: 0.07, grain: 0, colors: ["#0d0407", "#090600", "#0f0512", "#0c0400", "#0d030b", "#0a0502", "#070000", "#0e0011", "#010000", "#070012", "#070300", "#0b000b", "#11080c", "#1a0f00", "#0d0e33", "#270900", "#03000f", "#1b0b06", "#370e1c", "#131624", "#360000", "#000012", "#4a2717", "#17030b", "#895237", "#530421", "#ffdbff", "#150000", "#000000", "#b06251", "#74291d", "#ffffff", "#f6ffff", "#ffdedc", "#be94b0", "#3a1b15"] }] as any[]
    }
    ...
    a.gradient_fresh = {
        ...
        style: "",
        background: "#000000",
        items: [{ type: "mesh_gradient", duration: 24, speed: 1, motion: 0.07, grain: 0, colors: ["#eeb48c", "#f1ffff", "#ffd59d", "#000000", "#5a7e27", "#4f3e24", "#a7b06c", "#ffc9d2", "#b3ffff", "#ff7f48", "#000a00", "#325323", "#66a14e", "#ffefde", "#facad8", "#f9edd9", "#f63400", "#00152b", "#4cd08d", "#bc3400", "#ffe0b4", "#3d5182", "#ff9802", "#473c56", "#9da196", "#7a4230", "#ffe396", "#77b8ca", "#ff997f", "#bb9462", "#cac095", "#ffffff", "#bead9d", "#ffffff", "#c39269", "#ffd3c1"] }] as any[]
    }
    ...
    a.gradient_heat = {
        ...
        style: "",
        background: "#000000",
        items: [{ type: "mesh_gradient", duration: 24, speed: 1, motion: 0.07, grain: 0, colors: ["#ffffff", "#610f1d", "#010000", "#d89898", "#f2ffef", "#a981a3", "#ffffff", "#543565", "#b3634e", "#3a0000", "#f9d2b2", "#e0cfce", "#dbc2c3", "#e2e0d0", "#ffffff", "#000000", "#bc6866", "#ddcba3", "#e1bda4", "#aeaba8", "#ffffff", "#1b0000", "#220004", "#fffeca", "#e1a06e", "#908a8d", "#ffffff", "#b994b0", "#000000", "#d89678", "#6f372b", "#ffffff", "#dbe7e9", "#ffeec5", "#e5c6f1", "#3a0a00"] }] as any[]
    }
    ...
    a.gradient_ivy = {
        ...
        style: "",
        background: "#000000",
        items: [{ type: "mesh_gradient", duration: 24, speed: 1, motion: 0.07, grain: 0, colors: ["#15190e", "#1a190a", "#171b05", "#141311", "#1b1a06", "#18190a", "#191207", "#0c1200", "#110e17", "#1d2100", "#090f0f", "#111205", "#111f0b", "#2a2721", "#252500", "#000820", "#333311", "#201c13", "#3b3425", "#27310f", "#050215", "#a2935f", "#10040c", "#343c1c", "#daa7b0", "#aa9468", "#000000", "#937554", "#1e3814", "#4e4f1c", "#d9f0d3", "#fff7fc", "#6a4d6c", "#ffffff", "#323700", "#8ca145"] }] as any[]
    }
    ...
    a.gradient_joy = {
        ...
        style: "",
        background: "#000000",
        items: [{ type: "mesh_gradient", duration: 24, speed: 1, motion: 0.07, grain: 0, colors: ["#630000", "#ffdc51", "#ffb16a", "#1834b3", "#380086", "#949dd4", "#2a0521", "#ff8ea6", "#f2b2cd", "#c5ffff", "#de3b83", "#a93349", "#ffefb9", "#9767ba", "#ff6f3f", "#d5ffff", "#f09cce", "#e8870f", "#ffffa4", "#934ae1", "#92031a", "#ffffff", "#acab9c", "#ff8968", "#ffff5c", "#4d00d0", "#000043", "#fffff4", "#b6a4a9", "#e6afac", "#fef499", "#d56f80", "#0000a8", "#984fee", "#ffbc00", "#877eff"] }] as any[]
    }
    ...
    a.gradient_life = {
        ...
        style: "",
        background: "#000000",
        items: [{ type: "mesh_gradient", duration: 24, speed: 1, motion: 0.07, grain: 0, colors: ["#bac7b1", "#bbb9a3", "#5f8159", "#adae9a", "#bed1ae", "#2f3728", "#a3ba93", "#e8dede", "#333f20", "#616960", "#819b72", "#c9cbb5", "#554e57", "#d5ec99", "#000000", "#4f584e", "#ffffff", "#9eaa98", "#57705b", "#cfc19b", "#000000", "#feffd4", "#e1ede4", "#747d60", "#aab9ac", "#3d1912", "#408e31", "#ffdfff", "#ffffe7", "#504d49", "#2a3227", "#a6b2a3", "#3b6218", "#999b83", "#abbcad", "#586846"] }] as any[]
    }
