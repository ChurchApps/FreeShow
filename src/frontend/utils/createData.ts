    ...
    overlays.update((a) => {
                    ...
                    lines: [
                        {
                            ...
                            text: [
                                {
                                    value: "FreeShow",
                                    style: "font-size:50px;font-weight:bold;color:#F0008C;",
                                },
                            ],
                        },
                    ],
        ...
        a.visual = {
            ...
            items: [
                ...
                {
                    style: "top:80px;left:140px;height:40px;width:100px;",
                    lines: [{ align: "", text: [{ value: "REC", style: "font-size:40px;" }] }],
                },
            ],
        }
        a.clock = {
            ...
            items: [
                {
                    style: "top:70px;left:1450px;height:150px;width:470px;",
                    type: "clock",
                    clock: { type: "digital", seconds: false },
                },
            ],
        }
        a.name = {
                    ...
                    lines: [
                        {
                            ...
                            text: [
                                {
                                    value: "Name Surname",
                                    style: "font-family: Arial;font-size: 70px;text-shadow: 0 0 #000000;",
                                },
                            ],
                        },
                    ],
                    ...
                    lines: [
                        {
                            ...
                            text: [
                                {
                                    value: "Title",
                                    style: "font-family: Arial;font-size: 40px;font-weight: bold;text-transform:uppercase;text-shadow: 0 0 #000000;",
                                },
                            ],
                        },
                    ],
        ...
        a.vignette = {
            ...
            items: [
                {
                    style: "top: -180px;left: -200px;width: 2320px;height: 1440px;border-radius: 500px;box-shadow: inset 0px 0px 248px 0px #FFFFFF;",
                },
            ],
        }
        return a
                            ...
                            text: [
                                {
                                    ...
                                    style: "font-size: 30px;text-shadow: 2px 2px 4px rgb(0 0 0 / 80%);",
                                },
                            ],
                        },
                    ],
                            ...
                            text: [
                                {
                                    ...
                                    style: "font-size: 50px;text-shadow: 2px 2px 4px rgb(0 0 0 / 80%);",
                                },
                            ],
                        },
                    ],
                    ...
                    lines: [
                        {
                            ...
                            text: [
                                {
                                    value: "1",
                                    style: "font-size: 90px;line-height:1.2em;letter-spacing:2px;text-shadow: 0 0 #000000;",
                                },
                            ],
                        },
                        {
                    ...
                    lines: [
                        {
                            ...
                            text: [
                                {
                                    value: "1",
                                    style: "font-size: 90px;line-height:1.2em;letter-spacing:2px;",
                                },
                            ],
                        },
                        {
                    ...
                    lines: [
                        {
                            ...
                            text: [
                                {
                                    value: "1",
                                    style: "font-weight: bold;font-size: 80px;line-height:1.1em;letter-spacing:2px;text-shadow: 0 0 #000000;",
                                },
                            ],
                        },
                        {
                    ...
                    lines: [
                        {
                            ...
                            text: [
                                {
                                    value: "1",
                                    style: "font-size: 60px;line-height:1.5em;letter-spacing:2px;text-shadow: 0 0 #000000;",
                                },
                            ],
                        },
                        {
                    ...
                    lines: [
                        {
                            ...
                            text: [
                                {
                                    value: "1",
                                    style: "font-weight:bold;font-family:Arial;line-height:1.2em;font-size:120px;",
                                },
                            ],
                        },
                    ],
                    ...
                    lines: [
                        {
                            ...
                            text: [
                                {
                                    value: "1",
                                    style: "font-weight:bold;font-family:Arial;font-size:80px;line-height:1.2em;",
                                },
                            ],
                        },
                        {
                        ...
                        lines: [
                            {
                                ...
                                text: [
                                    {
                                        value: (get(dictionary).example?.welcome || "Welcome") + "!",
                                        style: "font-size: 180px;font-weight: bold;",
                                    },
                                ],
                            },
