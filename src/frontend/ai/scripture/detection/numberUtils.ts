...
// Utilities for normalizing spoken numbers and handling homophones.
// These are shared with LLM-based detection, so they are kept separate from command-related utilities.
...
const NUMBER_HOMOPHONES: { [word: string]: number } = { for: 4, won: 1, tree: 3, ate: 8 }
