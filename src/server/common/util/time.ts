...
export function dateToString(date: Date, full = false): string {
    date = new Date(date)
    ...
    if (full) {
        const d: any = {}
        // TODO: get dictionary...
        const weekday = d.weekday ? d.weekday[date.getDay()] : ["Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"][date.getDay()]
