<script lang="ts">
    ...
    const unsubscribeScripture = currentScriptureState.subscribe((state) => {
        ...
        if (hasValidOutput) {
            ...
            maybeSyncToDisplayed("activeScripture")
        } else {
    ...
    $: if (openedScriptureId && openedScriptureId !== lastOpenedScriptureId) {
        ...
        if (hasValidOutput) {
            ...
            maybeSyncToDisplayed("openedScripture")
        } else {
