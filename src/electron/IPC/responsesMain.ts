...
import { app, type DesktopCapturerSource, BrowserWindow, desktopCapturer, screen, shell, systemPreferences } from "electron"
import { machineIdSync } from "node-machine-id"
import os from "os"
import path from "path"
import { getMainWindow, isProd, mainWindow, maximizeMain, setGlobalMenu } from ".."
import { Main, type MainResponses } from "../../types/IPC/Main"
...
export const mainResponses: MainResponses = {
    ...
    // Chums CONNECTION
    [Main.CHUMS_LOAD_SERVICES]: (data) => chumsLoadServices(data.dataPath),
    [Main.CHUMS_STARTUP_LOAD]: (data) => chumsStartupLoad(data.dataPath),
