...
test.describe("Planning Center song keywords", () => {
    test("detects Planning Center control keyword lines", () => {
        ...
        expect(isPlanningCenterKeywordLine("SECTION HEADING")).toBe(true)
        expect(isPlanningCenterKeywordLine("SECTION_HEADING")).toBe(true)
        expect(isPlanningCenterKeywordLine("TRANSPOSE KEY + 2")).toBe(true)
        expect(isPlanningCenterKeywordLine("TRANSPOSE KEY +2")).toBe(true)
        expect(isPlanningCenterKeywordLine("TRANSPOSE KEY -2")).toBe(true)
        expect(isPlanningCenterKeywordLine("REDEFINE KEY +1")).toBe(true)
    })
